...
begin
  ...
  class MercurialAdapterTest < ActiveSupport::TestCase
    ...
    REPOSITORY_ARCHIVE_PATH = Rails.root.join('test/fixtures/repositories/mercurial_repository.hg').to_s
    REPOSITORY_PATH = Rails.root.join('tmp/test/mercurial_repository.hg').to_s
    CHAR_1_HEX = "\xc3\x9c"
