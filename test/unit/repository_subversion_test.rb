...
class RepositorySubversionTest < ActiveSupport::TestCase
  ...
  NUM_REV = 11
  REPOSITORY_ARCHIVE_PATH = Rails.root.join('test/fixtures/repositories/subversion_repository.dump').to_s
  REPOSITORY_PATH = Rails.root.join('tmp/test/subversion_repository').to_s
  ...
  def test_directory_listing_with_square_brackets_in_base
    ...
    @repository = Repository::Subversion.create(
                        :project => @project,
                        :url => "file:///#{REPOSITORY_PATH}/subversion_test/[folder_with_brackets]")
