...
ActiveRecord::Schema.define(:version => 20161024105024097) do
  ...
  create_table "group_invitations", :force => true do |t|
    t.integer  "friendship_status_id",                               :null => false
  ...
  create_table "invitation_user_messages", :id => false, :force => true do |t|
  ...
  create_table "meta_informations", :force => true do |t|
    t.string   "description"
  ...
  create_table "user_contacts", :force => true do |t|
    t.integer  "user_id"
    t.integer  "contact_member_id"
    t.datetime "created_at",        :null => false
    t.datetime "updated_at",        :null => false
  end

  add_index "user_contacts", ["contact_member_id"], :name => "index_user_contacts_on_contact_member_id"
  ...
  create_table "user_messages", :force => true do |t|
    ...
    t.datetime "created_at",                                              :null => false
    t.datetime "updated_at",                                              :null => false
    t.string   "message_type",           :limit => 30,    :default => "", :null => false
    t.integer  "message_id"
    t.integer  "user_message_parent_id"
  end
  ...
  create_table "users", :force => true do |t|
    ...
    t.boolean  "confirm"
    t.integer  "avatar_id"
    t.integer  "security_number",                  :default => 0
  end
